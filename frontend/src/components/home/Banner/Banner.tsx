              ...
              <div className='banner-content-area'>
                <div className='banner-content'>
                  <span className='subtitle'>
                    ...
                    Gems Beyond Measure, Prices Beyond Compare.
                    <svg
                      width='14'
                      height='14'
                      viewBox='0 0 14 14'
                  ...
                  <h1>
                  Discover <span>Rare Gems</span> Bid Your Dreams.
                  </h1>

                  <p>
                  Explore a world of rare gems through live auctions. Bid on exquisite stones and elevate your collection with brilliance.
                  </p>
